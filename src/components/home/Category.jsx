...
const Category = ({ setCategory }) => {
  ...
  return (
    <div className="w-full sm:w-1/4 md:w-1/5 lg:w-1/6 bg-gray-100 p-6 max-h-screen overflow-y-auto shadow-md rounded-lg">
      <div className="border-b pb-3 text-xl font-semibold text-gray-800 mb-4">
      ...
      <div>
        {categories?.map((category, i) => (
          <div
            ...
            className="text-lg cursor-pointer p-3 rounded-md hover:bg-blue-600 hover:text-white mb-2 transition duration-200 ease-in-out transform hover:scale-105"
          >
